...
- **For seeking/rewind (live TV and replay/catchup) to work**, set the addon's "Select Inputstream" setting to `inputstream.ffmpegdirect` -- it defaults to `inputstream.adaptive`, which doesn't support seeking with this addon
