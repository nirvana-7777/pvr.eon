...
static const std::string CLIENT_ID = "b8d9ade4-1093-46a7-a4f7-0e47be463c10";
static const std::string CLIENT_SECRET = "1w4dmww87x1e9l89essqvc81pidrqsa0li1rva23";
...
static const std::string DEVICE_TYPE = "web_linux_chrome";
static const std::string DEVICE_NAME = "";
static const std::string DEVICE_MODEL = "Chrome 112";
static const std::string DEVICE_PLATFORM ="web";
static const std::string SYSTEM_SW = "Linux";
static const std::string SYSTEM_VERSION = "x86_64";
