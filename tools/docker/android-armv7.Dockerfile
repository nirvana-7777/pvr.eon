...
COPY tools/docker/container-build-android-armv7.sh /usr/local/bin/container-build-android-armv7.sh
RUN chmod +x /usr/local/bin/container-build-android-armv7.sh

ENTRYPOINT ["/usr/local/bin/container-build-android-armv7.sh"]
